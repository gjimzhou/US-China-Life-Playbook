...
**v0.4：reader-facing reference pass 完成，进入持续核验与 link-health 阶段。**
...
当前维护重点从“补链接”转为**验证链接是否仍有效、动态规则是否仍当前、同类入口是否重复或漂移，以及地方 / 州别 / 个案边界是否表达清楚**。各章末尾继续保留事实核验范围；“首轮完成”不等于全书医学、法律、税务或保险个案已获专业审定。
