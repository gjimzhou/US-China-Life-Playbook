...
**v1.0：首个完整参考版（2026-09-23）。** 本轮语言、链接与阅读验收已完成；已知限制继续公开保留，版本号不代表所有内容获专业审定。

[版本说明与已知限制](docs/releases/v1.0.md) · [固定版本与附件](https://github.com/gjimzhou/US-China-Life-Playbook/releases) · [阅读验收记录](docs/reader-qa-2026-09-23.md)
