...
**v1.1：文风与阅读体验修订版（2026-09-23）。** 本轮完成定点文风编辑、场景分组、应急入口和搜索改进；已知限制继续公开保留，版本号不代表所有内容获专业审定。

[版本说明与已知限制](docs/releases/v1.1.md) · [固定版本与附件](https://github.com/gjimzhou/US-China-Life-Playbook/releases) · [本轮编辑与验收记录](docs/editorial-second-pass-2026-09-23.md)
