...
**本指南仍在编写与校订中，请勿盲从或直接照搬所有建议。** 内容仅供一般性参考，不替代针对个人的医疗、法律、税务、投资或移民专业意见，也不保证适用于每位读者或始终保持最新。

行动前请核对自己的具体条件、适用地区与日期，回到官方原始来源，并通过独立可靠渠道交叉验证。重大或不可逆事项，应由了解你完整情况的合格专业人士协助判断。紧急危险时立即联系当地应急服务，不要因查阅本文延误求助。

网站自动发布不等于内容自动完成事实核验。详见[完整阅读须知与免责声明](DISCLAIMER.md)。
...
- **事情突然发生，不知道第一步：** 从[生活事件索引](checklists/life-events-index.md)进入对应处理清单。

- **先补常识：** [第31章：第一代移民容易漏掉的100件生活小事](book/31-美国人默认知道的100件小事.md)。用短条目识别容易混淆的概念，再按需进入详细章节。
- **正在办事：** 从[场景清单目录](README.md#可执行清单)选择结婚、搬家、失业、旅行或其他实际事件；只处理与你有关的事项。

40章是按需查阅的参考，不是待完成的任务清单。不必逐章完成、购买所有产品或不断扩充家庭管理系统。
...
31. [第一代移民容易漏掉的100件生活小事](book/31-美国人默认知道的100件小事.md)
...
跨机构跟进可使用[办事记录与沟通示例](checklists/service-follow-up.md)，只记录必要字段。

| 场景 | 清单 |
|---|---|
| 约不到医生或医疗服务受阻 | [处理清单](checklists/medical-access-blocked.md) |
| 账单暂时付不起或金额有争议 | [处理清单](checklists/bill-payment-difficulty.md) |
| 银行账户冻结、受限或被关闭 | [处理清单](checklists/bank-account-restriction.md) |
| 航班取消、行李延误与旅行中断 | [处理清单](checklists/travel-disruption.md) |
...
| 租房全流程／提前解约／押金争议 | [租房全流程清单](checklists/rental-lifecycle.md) |
| 学龄期入学／转学／IEP／504 | [学龄期教育与支持清单](checklists/school-support.md) |
| 分居／离婚／家庭安全 | [分居、离婚与家庭安全清单](checklists/separation-family-safety.md) |
| 区域灾害／停电停水／撤离 | [灾害与公共服务中断清单](checklists/disaster-utility-outage.md) |
| 跨境办事失败／文件退件／汇款卡住 | [跨境办事失败排查清单](checklists/cross-border-problem.md) |
...
详见[写作规范](STYLE.md)与[中英术语表](GLOSSARY.md)。全书以此语言规范为目标；原有11份清单已完成此前校订，新增18份事件页面已完成本轮中文校订和指定关键事实复核；未决事实与正文新增段落继续按编辑进度审查。

## 来源与更新

优先采用政府文件、专业指南和可靠实务资料。对普通生活规则，引用的目标首先是**方便读者继续做事**：税务条目尽量直达 IRS / 州税务局的解释、表格或计算工具；移民条目直达 USCIS / 国务院办事页；消费者与保险条目直达投诉、查询或申诉入口。只有医学证据、风险大小或真实研究争议需要时，才重点链接学术论文。论坛、社交媒体与博客可提供问题线索，但高后果建议应回到第一手来源。

具体格式见[实用参考链接规范](references/citation-guide.md)：优先使用“官方原文 / 详细解释 / 办理入口 / 计算工具”等读者可理解的链接标签，而不是论文式编号脚注。

税务门槛、移民规则、申报期限、政府表格、保险要求和入境规则等动态内容，应注明“最后核验：年-月-日”。语言编辑日期与事实核验日期分开记录。

全库现有独立外链健康检查：`.github/workflows/link-health.yml` 每周运行，也可手动触发。它把明确的 404/410、反爬或限流（403/429）、网络暂时失败和正常重定向分开报告；**不会阻塞 GitHub Pages 发布**，也不会把自动请求被拦截误判成事实失效。
