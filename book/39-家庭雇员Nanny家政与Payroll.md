...
对于适用的常规家庭雇佣，按就业资格核验表（Form I-9）的要求完成核验并保留记录，不寄给国税局。允许员工按规则自己从 Lists of Acceptable Documents 选择文件，不能指定“必须给绿卡 / 护照”或额外要求国籍证明。偶发、零星家务服务等是否属于适用 domestic employment 边界须另核对。
