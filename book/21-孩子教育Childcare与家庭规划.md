...
入学、转学、长期学业／行为困难、家校沟通，以及怀疑需要 IDEA 特殊教育评估或 Section 504 支持，不能只停留在“多跟老师聊聊”。应保存具体例子、学校已尝试的支持和书面沟通；需要正式 evaluation 时，明确提出请求并保存日期、回复和程序文件。

**直接使用：** [学龄期教育与支持清单](../checklists/school-support.md)。
