...
**本项目实务建议：** 先定义 problem / jurisdiction / deadline / desired deliverable，再找专业人士。律师、税务、医生、保险分别从 [ABA](https://www.americanbar.org/groups/legal_services/flh-home/) · [IRS](https://www.irs.gov/tax-professionals/choosing-a-tax-professional) · [FSMB](https://www.fsmb.org/contact-a-state-medical-board/) · [NAIC](https://content.naic.org/state-insurance-departments) 开始。
...
**核验入口汇总：** [ABA Lawyer Referral](https://www.americanbar.org/groups/lawyer_referral/resources/lawyer-referral-directory/) · [IRS Preparer Directory](https://irs.treasury.gov/rpo/rpo.jsf) · [DocInfo](https://www.docinfo.org/) · [NIPR Licensing Center](https://nipr.com/licensing-center) · [FINRA BrokerCheck](https://brokercheck.finra.org/)。
...
**继续看：** [FTC：Hiring a Lawyer](https://consumer.ftc.gov/articles/hiring-lawyer)。具体 fee agreement、trust account 和 contingency rules 依州法与事项核对。
...
**继续看：** [IRS：Choosing a Tax Professional](https://www.irs.gov/tax-professionals/choosing-a-tax-professional)。无论谁编制，纳税人仍应在签名前审阅 return，并保留最终申报文件。
...
**规划入口：** [IRS Publication 505](https://www.irs.gov/publications/p505) · [IRS Tax Withholding Estimator](https://apps.irs.gov/app/tax-withholding-estimator) · [IRS International Taxpayers](https://www.irs.gov/individuals/international-taxpayers)。复杂交易仍需要专业人士把规则应用到具体事实。
...
**核验入口：** [FSMB / State Medical Boards](https://www.fsmb.org/contact-a-state-medical-board/) · [DocInfo](https://www.docinfo.org/) · [Medicare Care Compare](https://www.medicare.gov/care-compare/?providerType=Physician)。评价只补充体验信息，不替代执照、专业匹配与临床判断。
...
**找医生：** [Medicare Care Compare](https://www.medicare.gov/care-compare/?providerType=Physician)可作为候选入口；最终仍以本人 insurer directory 和诊所确认结果为准。
...
**核验入口：** [NIPR：Licensing Center](https://nipr.com/licensing-center) · [NAIC：State Insurance Department Directory](https://content.naic.org/state-insurance-departments)。“Independent”不等于覆盖全市场，carrier appointments / product access 直接问清。
...
**继续看：** [NAIC：Consumer Insurance](https://content.naic.org/consumer) · [Insurance Complaints](https://content.naic.org/consumer/insurance-complaints)。最终以 declarations、policy forms 与 endorsements 为准。
...
**继续看：** [Investor.gov：Check Out Your Investment Professional](https://www.investor.gov/introduction-investing/getting-started/working-investment-professional/check-out-your-investment-professional) · [SEC IAPD](https://adviserinfo.sec.gov/) · [FINRA BrokerCheck](https://brokercheck.finra.org/)。
...
**本项目实务建议：** “已发邮件”不等于延期。律师替换按法院 / bar rules，税务 / 医疗 / 保险则按实际机构交接流程；候选入口可从 [ABA](https://www.americanbar.org/groups/legal_services/flh-home/) / [IRS](https://www.irs.gov/tax-professionals/choosing-a-tax-professional) / [FSMB](https://www.fsmb.org/contact-a-state-medical-board/) / [NAIC](https://content.naic.org/state-insurance-departments)重新寻找。

## 23. 敏感材料通过核实的渠道传递

确认平台来自机构正式渠道、谁能访问、保存多久、如何取回。先提供必要信息，避免把完整证件或财务资料群发给多名候选。遇到突然更改收款账号，使用此前核实的号码回拨确认。

**安全参考：** [CISA：Secure Our World](https://www.cisa.gov/secure-our-world) · [FBI IC3：Business Email Compromise](https://www.ic3.gov/CrimeInfo/BEC)。
