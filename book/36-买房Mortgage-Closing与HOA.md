...
- **购买住房的 mortgage：** CFPB 当前明确说明，买房贷款一旦 closing documents 签署，**没有一般性的联邦三营业日 right of rescission**。不要在签约时想着“反正签完还有三天可以无条件取消贷款”。
- **Closing Disclosure：** 对多数适用 purchase mortgage，消费者应在 consummation / closing 前至少 3 个营业日**收到** Closing Disclosure，目的是提前审阅，不是 closing 后的冷静期。
- **Certain refinance / home-equity transactions：** 多数 non-purchase-money mortgage 才可能有联邦三营业日 rescission。该 clock 通常从三个事件中**最后发生的一个**之后开始：完成 transaction、收到 material Truth in Lending disclosures、收到 required rescission notice。为 rescission 计日时，Saturday 通常算 business day，Sunday 和 federal legal holiday 不算。
- 对适用 rescission 的交易，取消必须按要求**书面通知** creditor；仅打电话说“我反悔了”不等于完成法定 rescission。

如果 refinance / home equity lender 没有正确给 required disclosures / rescission notices，某些情形下 rescission right 可能延长到更久，甚至最高 3 年；这种情况不要自己套公式，立即找合适律师评估。

**直接核对：** [CFPB：Buying a home vs refinancing — right of rescission](https://www.consumerfinance.gov/ask-cfpb/how-long-do-i-have-to-rescind-when-does-the-right-of-rescission-start-en-187/) · [CFPB：Second mortgage / refinance right to cancel](https://www.consumerfinance.gov/ask-cfpb/can-i-change-my-mind-after-i-sign-the-loan-closing-documents-for-my-second-mortgage-or-refinance-what-is-the-right-of-rescission-en-186/) · [Regulation Z §1026.23](https://www.consumerfinance.gov/rules-policy/regulations/1026/23/)。
