...
租客除了报修和搬家，还应把看房、费用核对、签约、入住状态记录、租期中书面沟通、转租／提前解约、正式 notice、退租检查和押金结算视为一条连续流程。州和地方的 notice、security deposit、eviction 与 tenant-rights 规则差异很大，不从其他州攻略直接复制天数或金额。

**直接使用：** [租房全流程清单](../checklists/rental-lifecycle.md)。
