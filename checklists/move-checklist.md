...
按签约、搬出、搬入等实际节点安排；提前量因合同与机构而异。地址变更、医保和税务是独立事项，不随搬箱子自动完成。详见[第09章住房](../book/09-住房物业与Contractor.md)、[第14章州税务](../book/14-美国税务与State-Residency.md)及[第18章两地生活](../book/18-中美双栖生活基础设施.md)。
...
- [ ] 办理适用邮政转寄，另向车辆管理、税务、移民及其他相关机构更新。
...
- [ ] 拍摄房屋状态，保存维修沟通和水电读数。
- [ ] 清空储藏空间，检查邮件、停车权限、钥匙与门禁。
- [ ] 确认交还日期、验收与押金后续程序，留存交接凭证。

## 搬入前与当天

- [ ] 检查新址烟雾及适用的一氧化碳报警器、水阀、配电箱、逃生路线及紧急维修入口。
- [ ] 按权限更新锁具与门禁，确认水电网络和必要家电。
- [ ] 证件、药物、重要文件和贵重物品单独安全保管。
- [ ] 核对搬运清单，及时记录损坏与缺失，保存照片和签收条件。
- [ ] 安排孩子与宠物安全，勿让其混入搬运作业区域。

## 安顿后

- [ ] 更新家庭紧急信息表和附近急诊、紧急门诊及夜间兽医信息。
- [ ] 认识物业人员，了解停车、包裹、邮件和废弃物处理规则。
- [ ] 建立必要水电暖通及锁匠入口，确认本地非紧急政务渠道。
- [ ] 按意愿认识邻居，选择一项愿意持续参加的活动及交通备选方案。

## 跨州特别检查

- [ ] 按实际期限处理驾照、车辆登记、检查与车险。
...
| 机构或服务 | 生效日期／期限出处 | 已提交 | 确认凭证 | 旧服务终止／退款 | 未结事项及负责人 |
|---|---|---|---|---|---|
|  |  |  |  |  |  |

最后确认新服务实际可用、旧服务按计划结束，避免重复收费或中断。



模板校订与 Marketplace 搬家规则复核：2026-09-21
