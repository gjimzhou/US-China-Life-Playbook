...
取得拒付／拒绝的准确措辞和参考编号，问处方医生所在诊所是否有事先授权团队；如果保险公司正式拒付，查计划的申诉／例外申请路径，并核对[医疗拒赔期限及限时更新](../book/04-美国医疗系统怎么用.md#6-拒赔后先弄清原因再走书面程序)。病情不允许等待时，让临床团队同时制定临时方案，并询问是否符合加急审查条件；不要把保险审批当作唯一的医疗处理路径。
