...
- 第01—40章与原有11份清单已完成此前逐段校订；2026-09-21 首轮新增8份事件型清单；2026-09-22 再新增6份（怀孕／妊娠丢失与生产、重大诊断／出院、钱包／证件丢失、车辆抛锚／拖车／罚单、宠物走失、犯罪受害／失踪），当前总数为25份。新增14份已完成结构、语言和关键官方／专业入口的初步核验，但仍需按原11份清单相同深度继续做逐项事实审计。
...
**原首轮 reader-facing reference pass 已完成：40 / 40 章正文 + 原有 11 / 11 份执行清单。** 之后共新增14份事件型清单；它们已接入官方／专业入口并进入下一轮逐项核验，因此不把“25份都已同深度审定”作为当前结论。
...
5. 把正文与所有 checklist 的“去办 / 核验”入口保持一致；新增14份事件型清单优先完成逐条 dynamic-fact audit。
...
1. 已完成原有11份清单的逐段对照与中文校订；随后新增14份事件型清单：首轮8份为生活事件索引、宠物去世、心理健康、租房、学龄支持、分居与家庭安全、灾害／公共服务中断、跨境失败排查；第二轮6份为怀孕／妊娠丢失与生产、重大诊断／出院、钱包／证件丢失、车辆抛锚／拖车／罚单、宠物走失、犯罪受害／失踪。当前共25份。
