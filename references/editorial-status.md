...
- 第01—40章与原有11份清单已完成此前逐段校订；2026-09-21 另新增8份事件型清单，使当前总数为19份。新增清单已完成结构、语言和关键官方入口的初步核验，但仍需按原11份清单相同深度继续做逐项事实审计。
...
**原首轮 reader-facing reference pass 已完成：40 / 40 章正文 + 原有 11 / 11 份执行清单。** 之后新增8份事件型清单；它们已接入官方／专业入口并进入下一轮逐项核验，因此不把“19份都已同深度审定”作为当前结论。
...
1. 已完成原有11份清单的逐段对照与中文校订；随后新增8份事件型清单（生活事件索引、宠物去世、心理健康、租房、学龄支持、分居与家庭安全、灾害／公共服务中断、跨境失败排查），当前共19份。
