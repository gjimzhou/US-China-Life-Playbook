...
- 第01—40章与原有11份清单已完成此前逐段校订；2026-09-21 首轮新增8份事件型清单；2026-09-22 第二波新增6份（怀孕／妊娠丢失与生产、重大诊断／出院、钱包／证件丢失、车辆抛锚／拖车／罚单、宠物走失、犯罪受害／失踪），随后第三波再新增4份（工伤／请假、药物获取失败、Jury／法院通知、USCIS Notice 处理），当前总数为29份。新增18份已完成结构、语言和关键官方／专业入口的初步核验，但仍需按原11份清单相同深度继续做逐项事实审计。
...
1. 已完成原有11份清单的逐段对照与中文校订；随后新增14份事件型清单：首轮8份为生活事件索引、宠物去世、心理健康、租房、学龄支持、分居与家庭安全、灾害／公共服务中断、跨境失败排查；第二轮6份为怀孕／妊娠丢失与生产、重大诊断／出院、钱包／证件丢失、车辆抛锚／拖车／罚单、宠物走失、犯罪受害／失踪。第三波4份为工伤／请假、药物获取失败、Jury／法院通知、USCIS Notice 处理。当前共29份。
