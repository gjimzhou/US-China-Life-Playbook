...
- 第01—40章与原有11份清单已完成此前逐段校订；2026-09-21 首轮新增8份事件型清单；2026-09-22 第二波新增6份（怀孕／妊娠丢失与生产、重大诊断／出院、钱包／证件丢失、车辆抛锚／拖车／罚单、宠物走失、犯罪受害／失踪），随后第三波再新增4份（工伤／请假、药物获取失败、Jury／法院通知、USCIS Notice 处理），当前总数为29份。新增18份已接入目录并完成结构检查及部分关键官方／专业入口的初步核验；截至2026-09-23，新增18份已完成本轮中文校订、结构审阅与指定关键事实核验；逐页范围与未决事项见下方第二批记录，不能据此宣称全部条目均已审定。
