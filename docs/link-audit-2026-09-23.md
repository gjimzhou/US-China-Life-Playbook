...
两个最后遗留入口替换后，本地与GitHub独立扫描均检查830个唯一外链，明确404／410均为0。访问受限、临时失败和其他警告继续分别记录，没有视为成功，也未加入忽略名单。计数、运行链接与验证边界见[阅读验收记录](reader-qa-2026-09-23.md)。本页上方保留原始故障与修复过程，不代表仍有27个坏链待修。
