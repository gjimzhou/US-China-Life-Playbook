...
10. 正文与代码许可分开，遵守 `COPYRIGHT.md` 和 `LICENSING.md`；未经权利人明确授权，不改为 CC、MIT 或公有领域，不新增整站导出或镜像。保留既有有效授权。
11. 不对事实、法律、公共数据、思想或方法主张排他权；不虚构作者贡献或核验日期。保留稳定引用链接、无障碍阅读与现有个人下载功能。
