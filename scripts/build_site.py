...
paths=sorted((ROOT/'book').glob('*.md'))+sorted((ROOT/'checklists').glob('*.md'))+[ROOT/p for p in ['HOME.md','references/editorial-status.md','DISCLAIMER.md','GLOSSARY.md','METHODOLOGY.md','STYLE.md','CONTRIBUTING.md','references/source-policy.md','README.md','DOWNLOADS.md']]
...
for asset in ['app.js','theme.js','style.css','vendor/marked.js','reader.js','tools.js']:
